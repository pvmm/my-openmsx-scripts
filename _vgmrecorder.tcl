...
proc write_opl3_data {} {
	variable opl3_register
	variable active_opl3_port
	if {$opl3_register >= 0} {
		update_time
		variable music_data
		append music_data [binary format ccc [expr {0x5E + $active_opl3_port}] $opl3_register $::wp_last_value]
	}
}
